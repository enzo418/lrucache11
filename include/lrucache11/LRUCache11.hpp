...
namespace lru11 {
    ...
    concept CallableRboolAKeyValue = std::is_invocable_r_v<bool, T, K, V>;
#endif
     ...
     */
    template <
        class Key, class Value, typename _Hash = std::hash<Key>,
        class Lock = NullLock,
        class Map = std::unordered_map<
            Key, typename std::list<KeyValuePair<Key, Value>>::iterator, _Hash>>
    class Cache {
       public:
